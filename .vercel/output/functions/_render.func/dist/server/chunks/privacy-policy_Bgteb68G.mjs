...
const html = () => "<p>It may be recommended to generate policies from <a href=\"https://policymaker.io\" rel=\"nofollow noopener noreferrer\" target=\"_blank\">PolicyMaker.io<span style=\"user-select:none\"> ↗</span></a>.</p>";
				...
				const frontmatter = {"layout":"@/layouts/IndividualPage.astro","title":"Privacy Policy","description":"Effective date: 2024-11-26","language":"En","back":"/terms/list","minutesRead":"1 min","words":9};
				const file = "/Users/mokiia1107/Documents/GitHub/Mokiia-website/src/pages/terms/privacy-policy.md";
