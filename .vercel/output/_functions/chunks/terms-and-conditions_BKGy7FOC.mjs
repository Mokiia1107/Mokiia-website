...
import 'piccolore';
import { r as renderComponent, b as renderTemplate, u as unescapeHTML } from './entrypoint_C9AHn4Vx.mjs';
import { $ as $$IndividualPage } from './IndividualPage_A1kvSh7X.mjs';
...
const html = () => "<p>It may be recommended to generate policies from <a href=\"https://policymaker.io\" rel=\"nofollow noopener noreferrer\" target=\"_blank\">PolicyMaker.io<span style=\"user-select:none\"> ↗</span></a>.</p>";
				...
				const frontmatter = {"layout":"@/layouts/IndividualPage.astro","title":"Terms and Conditions","description":"Last updated: 2024-11-26","language":"En","back":"/terms/list","minutesRead":"1 min","words":9};
				const file = "/Users/mokiia1107/Documents/GitHub/Mokiia-website/src/pages/terms/terms-and-conditions.md";
